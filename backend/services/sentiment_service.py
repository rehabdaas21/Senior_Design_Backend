...
FUSION_CHECKPOINT = BASE_DIR / "models" / "fusion_model.pt"
...
def predict_emotion(text: str, audio_file: str = None) -> EmotionState:
    """
    ...
    """
    processor, distilbert, tokenizer, audio_model, fusion_model = _load_models()
